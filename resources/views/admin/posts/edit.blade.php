            ...
            <form method="post" id="form-reset">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea  class="form-control" name="text" id="text" rows="3" placeholder="Enter ..."> {{$post->text}} </textarea>
                    </div>
                ...
                <div class="card-footer">
                    <button type="button" onclick="updateItem({{$post->id}})" class="btn btn-primary">Submit</button>
                </div>
            </form>
        </div>
        <!-- /.card -->
